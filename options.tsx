...
function OptionsIndex() {
  ...
  const onDownloadConfig = useCallback(() => {
    try {
      ...
      const now = new Date()
      a.href = url
      a.download = `notion-flow-${now.getFullYear()}-${
        now.getMonth() + 1
      }-${now.getDate()}_${now.getHours()}_${now.getMinutes()}.json`
    ...
    <>
      ...
      <Row>
        <Col span={18} offset={3}>
          ...
          <Paragraph>
            <Button onClick={onDownloadConfig} icon={<UploadOutlined />}>
              {LocaleConfig.Options.Common.Export}
            </Button>
            <Divider type="vertical" />
            <Button onClick={onUploadConfig} icon={<DownloadOutlined />}>
              {LocaleConfig.Options.Common.Import}
            </Button>
          </Paragraph>
          <Divider
            orientationMargin="0"
          ...
          <Form
            ...
            <Form.Item
              ...
              <Radio.Group>
                <Radio.Button value="text">
                  {LocaleConfig.Options.Basic.Toc.Text}
                </Radio.Button>
                <Radio.Button value="number">
                  {LocaleConfig.Options.Basic.Toc.Number}
                </Radio.Button>
                <Radio.Button value="none">
                  {LocaleConfig.Options.Basic.Toc.None}
                </Radio.Button>
              </Radio.Group>
            </Form.Item>
            <Form.Item
              key={"scroll-animation"}
              label={LocaleConfig.Options.Basic.ScrollAnimation}
              name="scroll-animation">
              <Switch />
            </Form.Item>
            <Paragraph>
              <Text strong>{LocaleConfig.Options.Basic.MoreFeature}</Text>
            </Paragraph>
            <Divider
              orientationMargin="0"
              orientation="left"
            ...
            <Form.Item
              ...
              style={{ marginBottom: 20 }}
              rules={[
                { required: true, message: LocaleConfig.Options.Notion.Message }
              ]}
              name={["notion", "token"]}
            ...
            <div style={{ display: enablePublisher ? "block" : "none" }}>
              ...
              <Form.Item
                ...
                label={
                  LocaleConfig.Options.Publisher.Common.EnableFrontMatter.Label
                }
                extra={
                  LocaleConfig.Options.Publisher.Common.EnableFrontMatter.Desc
                }>
                <Switch />
              </Form.Item>
              ...
              <Form.Item
                ...
                <Radio.Group>
                  {Object.keys(ossFormItems(LocaleConfig)).map((key) => (
                    <Radio.Button key={key} value={key}>
                      {ossNameMap(LocaleConfig)[key]}
                    </Radio.Button>
                  ))}
                </Radio.Group>
              </Form.Item>
              <div
                style={{
                  display:
                    ossName && ossFormItems(LocaleConfig)[ossName]
                      ? "block"
                      : "none"
                }}>
                {ossName &&
                  ossFormItems(LocaleConfig)[ossName].map((item, key) => {
                    const {
                      label,
                      tooltips: _tooltips,
                      message,
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message:
                      LocaleConfig.Options.Publisher.Github.FilePath.Message
                  }
                ]}
                /* tooltip={tooltips({
                ...
                <Input
                  placeholder={
                    LocaleConfig.Options.Publisher.Github.FilePath.Placeholder
                  }
                />
              </Form.Item>
              <Form.Item
                ...
                style={{ marginBottom: 20 }}
                extra={
                  LocaleConfig.Options.Publisher.Github.AddLastUpdateTime.Extra
                }
                label={
                  LocaleConfig.Options.Publisher.Github.AddLastUpdateTime.Label
                }>
                <Switch />
              </Form.Item>
              <Form.Item
                ...
                style={{ marginBottom: 20 }}
                extra={
                  LocaleConfig.Options.Publisher.Github
                    .UpdateNotionLastUpdateTime.Extra
                }
                label={
                  LocaleConfig.Options.Publisher.Github
                    .UpdateNotionLastUpdateTime.Label
                }>
                <Switch />
              </Form.Item>
              <Form.Item
                ...
                <Input
                  placeholder={
                    LocaleConfig.Options.Publisher.Github.FrontMatter
                      .Placeholder
                  }
                />
              </Form.Item>
              <Form.Item
                ...
                style={{ marginBottom: 20 }}
                extra={
                  LocaleConfig.Options.Publisher.Github.HeaderImgName.Extra
                }
                label={
                  LocaleConfig.Options.Publisher.Github.HeaderImgName.Label
                }>
                <Input
                  placeholder={
                    LocaleConfig.Options.Publisher.Github.HeaderImgName
                      .Placeholder
                  }
                />
              </Form.Item>
          ...
          <Divider
            ...
            orientation="left"
            style={{ fontSize: 30 }}>
            {LocaleConfig.Options.About.Label}
          </Divider>
          <Paragraph>
            <Text>
              Version:&nbsp;&nbsp;
              <Link href={LocaleConfig.Options.About.Version} target="_blank">
                0.4.4
              </Link>
            </Text>
            <br />
            <Text>
              Email:&nbsp;&nbsp;
              <Link href="mailto:c1006044256@gmail.com" target="_blank">
                c1006044256[at]gmail.com
              </Link>
            </Text>
            <br />
            <Text>
              Blog:&nbsp;&nbsp;
              <Link href="https://www.xheldon.com" target="_blank">
            ...
            <Text>
              Donate:&nbsp;&nbsp;
              <Link href={LocaleConfig.Options.About.Donate} target="_blank">
                Support my work!
              </Link>
            </Text>
            <br />
            <Text>
              <Link href="https://t.me/+AN6Y9ngg8g9kNmVl" target="_blank">
                Telegrem
              </Link>
              &nbsp; | &nbsp;
              <Link href="https://twitter.com/real_notionflow" target="_blank">
                Twitter
              </Link>
              &nbsp; | &nbsp;
              <Link href="https://twitter.com/_Xheldon" target="_blank">
                Author Twitter
              </Link>
              &nbsp; | &nbsp;
              <Link
                href="https://github.com/Xheldon/Notion-Flow-Prod/issues"
                target="_blank">
                Issues
              </Link>
              &nbsp; | &nbsp;
              <Link
                href="https://github.com/Xheldon/Notion-Flow-Prod/discussions"
                target="_blank">
                Discussions
              </Link>
            </Text>
